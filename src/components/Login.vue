<template>
  <div class="w-screen h-screen absolute flex justify-center items-center">
    <div class="absolute h-1/3 w-1/4 shadow shadow-gray-400 rounded-2xl flex flex-col justify-center items-center">
      ...
      <input class="input w-1/2 mb-4" placeholder="Username" type="text">
      <input class="input w-1/2" placeholder="Password" type="password">
      <button class="btn btn-primary mt-5" @click="login">Login</button>
      <a href="/register" class="text-sm url">No Account? Create one here!</a>
    </div>
  </div>
</template>
